    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Review for {{ $review->product->name }}</h5>
                <a href="{{ route('reviews.index', $review->product_id) }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reviews.update', $review->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="comment" id="comment" rows="5" class="form-control @error('comment') is-invalid @enderror" placeholder="Write your review here...">{{ old('comment', $review->comment) }}</textarea>
                        @error('comment')
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('reviews.index', $review->product_id) }}" class="btn btn-secondary me-2">Cancel</a>
